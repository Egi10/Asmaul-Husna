...
import com.example.egi_fcb.asmaulhusna.adapter.RecyclerViewAdapter;
...
public class ActivityAsmaulHusna extends AppCompatActivity {
    ...
    private List<ActivityAsmaulHusna.User2> getUserInformationn() {
    ...
    private List<ActivityAsmaulHusna.User> getUserInformation() {
